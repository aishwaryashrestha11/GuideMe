...
public class CustomerUserAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_user_area);
        ...
        // Send();
        Intent i=new Intent();
        i.setAction("com.example.aadmin.guidemethree.RegisterActivity.CustomerUserAreaActivity");
...
user area
    ...
    {
        startActivity(new Intent(CustomerUserAreaActivity.this,MainActivity.class));
    }
}
